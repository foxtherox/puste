const translations = {
    ...
    en: {
        ...
        song: "Song of Experiencing Death",
        prolog: "Prologue",
        plenery: "Plein-airs",

        child: "Once I Was a Child",
        lie: "Falsehood",
        boy: "Boy",
        grodzisko: "Hillfort",
        kapliczka: "Chapel by the Tree",
        nauka: "Study",
        dysputa: "Dispute at the Crossing",
        droga: "Road Across the Bridge",
        crossroads: "Crossroads",
        puste: "Empty Place",
        tree: "Lonely Tree",
        spark: "Twinkle in the Eye",
        rana: "Wound from the Past",
        propozycja: "Proposal",
        shadow: "Shadow in Town",
        gora: "Holy Mountain",
        zamek: "Castle",
        response: "Answer",
        ...
        lock: "Connection",
        zadomem: "Behind the House",
        zagajnik: "Grove",
        oczekiwanie: "Vigil in the Garden",
        bath: "Bath",
        stany: "Three States",
        ...
        "paradise-poem-03":
            ...
            you’ve been looking for the passage for so long<br>
            that chapter is behind you now<br>
            you must pass through`,

        "paradise-poem-04":
            `a new mystery addresses you<br>
            your previous life belongs to someone else<br>
            you are not them<br>
            you must pass through every gate you stumble upon<br>
            sometimes you will find yourself in a dead end<br>
            do not lose heart<br>
            look at it<br>
            patiently<br>
            and a passage will present itself<br>
            you will not know where you are going<br>
            yet the road feels familiar`,

        "paradise-poem-05":
            `Rome is a blend of other people's memories and me<br>
            Rome teaches me to flow<br>
            Rome flows through me<br>
            it taught me<br>
            how to let it in<br>
            then Rome is everywhere<br>
            and I<br>
            am it<br>
            when I am in Rome<br>
            I paint like Rome`,
        ...
        "paradise-poem-08":
            ...
            what for<br>
            you are waiting<br>
            so once it arrives<br>
            whatever it may be<br>
            you will know that it has arrived<br>
            the thing<br>
            you know<br>
        ...
        "paradise-poem-10":
            `it opened<br>
            for a moment<br>
            as long as eternity<br>
            a passage<br>
            a tunnel of passages<br>
    ...
    pl: {
        ...
        song: "Pieśń doświadczania śmierci",
        prolog: "Prolog",
        plenery: "Plenery",

        child: "Kiedyś byłem dzieckiem",
        lie: "Zakłamanie",
        boy: "Chłopiec",
        grodzisko: "Grodzisko",
        kapliczka: "Kapliczka przy drzewie",
        nauka: "Nauka",
        dysputa: "Dysputa przy przejściu",
        droga: "Droga przez most",
        crossroads: "Rozdroże",
        puste: "Puste miejsce",
        tree: "Samotne drzewo",
        spark: "Błysk w oku",
        rana: "Rana z przeszłości",
        propozycja: "Propozycja",
        shadow: "Cień w miasteczku",
        gora: "Święta góra",
        zamek: "Zamek",
        response: "Odpowiedź",
        ...
        zadomem: "Za domem",
        zagajnik: "Zagajnik",
        oczekiwanie: "Oczekiwanie w ogrójcu",
        bath: "Kąpiel",
        stany: "Trzy stany",
        ...
        "paradise-poem-02":
            ...
            że wszystko<br>
            na co patrzyłeś<br>
            zostanie przemienione<br>
            za sprawą<br>
            co najmniej przypadku`,

        "paradise-poem-03":
            `musisz przejść<br>
            szukałeś drzwi tak długo<br>
            ten etap już za tobą<br>
            musisz przejść`,

        "paradise-poem-04":
            `mówi do ciebie nowa tajemnica<br>
                        poprzednie życie jest czyimś innym<br>
                        nie jesteś nim<br>
                        musisz przejść przez wszystkie bramy które napotkasz<br>
                        czasem wpadniesz w ślepy zaułek<br>
                        nie zniechęcaj się<br>
                        patrz na niego<br>
                        cierpliwie<br>
                        a otworzy się przejście<br>
                        i nie będziesz wiedział gdzie idziesz<br>
                        a droga będzie znajoma`,

        "paradise-poem-05":
            `Rzym to mieszanka cudzych wspomnień i mnie<br>
                        Rzym uczy mnie płynąć<br>
                        Rzym przeze mnie płynie<br>
                        nauczył mnie<br>
                        jak mu pozwalać<br>
                        wtedy Rzym jest wszędzie<br>
                        i ja<br>
                        jestem nim<br>
                        gdy jestem w Rzymie<br>
                        to maluję jak Rzym`,

        "paradise-poem-06":
            `spowija mi oczy mgła<br>
            mgła zasłania szum`,
        ...
        "paradise-poem-08":
            `musisz czekać<br>
                            ...
                            czekasz<br>
                            gdy przyjdzie<br>
                            cokolwiek by to nie było<br>
                            będziesz wiedział że przyszło<br>
                            to<br>
                            na co wiesz<br>
                            ze czekałeś`,
